...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHΛИИΞL 💠', url='https://t.me/RTS_TG1'),
            InlineKeyboardButton('💠 UᎮDΛTΞS 💠', url='https://t.me/Simplyseries6_1')
            ],[      
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐋𝐈𝐒𝐓​', url='https://t.me/RTS_TG1/49') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
